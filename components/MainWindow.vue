<template>
    <p
        class="HoverText"
        v-bind:style="new Date().getMonth() != 5 ? 'display: none;' : ''"
    >
        its gay liberal woke month ‼️ :3
    </p>
    <div class="MainWindow">
        <div class="TitleBar">
            <button
                class="LogoButton"
                @click="toggleTheme"
                v-bind:title="colorMode.preference"
            >
                <img
                    v-bind:src="getIcon()"
                    class="Icon"
                    v-bind:alt="colorMode.preference"
                />
            </button>
            <div class="Tabs">
                ...
                <NuxtLink
                    v-bind:class="getClass('projects', false)"
                    to="/projects"
                >
                ...
                <NuxtLink
                    v-bind:class="getClass('stats', false)"
                    to="/statistics"
                >
                ...
                <NuxtLink
                    v-bind:class="getClass('gallery', false)"
                    to="/gallery"
                >
                ...
                <NuxtLink v-bind:class="getClass('blog', false)" to="/blog">
                    <img
                        src="~/assets/svg/chat-bubble-text-inverted-symbolic.svg"
                    />
                    <p>Blog</p>
                </NuxtLink>
            </div>
            <NuxtLink
                class="LogoButton End"
                to="https://github.com/MyNameTsThad/iw2tryhard-dev-3.0"
            >
                <img
                    src="~/assets/svg/github-desktop-symbolic.svg"
                    class="ThinIcon"
                    alt="github"
                />
            </NuxtLink>
        ...
        <div class="BottomBar">
            <div class="BottomTabs">
                ...
                <NuxtLink
                    v-bind:class="getClass('projects', true)"
                    to="/projects"
                >
                    <img src="~/assets/svg/build-alt-symbolic.svg" />
                    <p>Projects</p>
                ...
                <NuxtLink
                    v-bind:class="getClass('stats', true)"
                    to="/statistics"
                >
                    <img src="~/assets/svg/align-tool-symbolic.svg" />
                    <p>Statistics</p>
                ...
                <NuxtLink
                    v-bind:class="getClass('gallery', true)"
                    to="/gallery"
                >
                    <img src="~/assets/svg/image-round-symbolic.svg" />
                    <p>Gallery</p>
